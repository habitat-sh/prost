...
impl <'a> CodeGenerator<'a> {
    ...
    fn append_message(&mut self, message: DescriptorProto) {
        ...
        self.append_doc();
        self.push_indent();
        self.buf.push_str("#[derive(Clone, Debug, PartialEq, Message, Serialize, Deserialize)]\n");
        self.push_indent();
    ...
    fn append_oneof(&mut self,
        ...
        self.push_indent();
        self.buf.push_str("#[derive(Clone, Debug, Oneof, PartialEq, Serialize, Deserialize)]\n");
        self.push_indent();
